 ...
 * are given in first name box
 * @author - AaronKranzler
 */
public class HiveTest3Point12  {
    public static void main(String[] args) {
        ...
        firstNameBox.sendKeys("Aaron;;;");//illegal characters
        ...
        try{ 
            ...
            System.out.println("Test 3.12 failed, the Invalid error isn't displayed even though the first name input uses illegal characters");
            properFunctionality = false;
        }

        if(properFunctionality)
        {
            System.out.println("Test 3.12 passed, the Invalid error is displayed because the first name input uses illegal characters");
        }
