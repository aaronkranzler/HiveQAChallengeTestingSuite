...
public class HiveTest5Point1  {
    public static void main(String[] args) {
        ...
        //WebElement continueButton4 = driver.findElement(By.cssSelector(".hv.btn.btn-primary.js-complete-step"));
        	try {
				Thread.sleep(1000);
        ...
        {
            System.out.println("Test 5.1 passed, the continue button is enabled with no input");
        }
        else
        {
            System.out.println("Test 5.1 failed, the continue button is disabled with no input");
        }
