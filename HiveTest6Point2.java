...
/*
 * Test to ensure that "Continue" button is disabled when invalid input is given
 * @author - Aaron Kranzler
 */
public class HiveTest6Point2  {
    public static void main(String[] args) {
        ...
        firstEmailBox.sendKeys("**;;;kalsdf");//invalid email
        ...
        secondEmailBox.sendKeys("**;;");//invalid email
        ...
        thirdEmailBox.sendKeys("**;;adsjl");//invalid email
        ...
        {
            System.out.println("Test 6.2 passed, the continue button is disabled because there is invalid input");
        }
        else
        {
            System.out.println("Test 6.2 failed, the continue button is enabled even though there is invalid input");
        }
