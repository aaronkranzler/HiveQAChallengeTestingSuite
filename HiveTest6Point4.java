...
/*
 * Test to ensure that "Continue" button routes to a new page when clicked
 * @author - Aaron Kranzler
 */
public class HiveTest6Point4  {
    public static void main(String[] args) {
        ...
        {
            System.out.println("Test 6.4 passed, the continue button routed to a new page when clicked");
        }
        else
        {
            System.out.println("Test 6.4 failed, the continue button did not route to a new page when clicked");
        }
