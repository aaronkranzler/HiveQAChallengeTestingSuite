...
/*
 * Test to ensure that "Finish" button is disabled when Google Drive, Dropbox, and Box 
 * accoutns are not linked 
 * @author - Aaron Kranzler
 */
public class HiveTest7Point3  {
    public static void main(String[] args) {
        ...
        //NOTE: Google Drive, Dropbox, and Box accounts have not been linked
        WebElement finishButton = driver.findElement(By.cssSelector(".hv.btn.btn-primary.js-complete-step"));

        if(finishButton.isEnabled())
        {
            System.out.println("Test 7.3 failed, Finish button is enabled even though Drive, Box and Dropbox accounts have not been linked");
        }
        else
        {
            System.out.println("Test 7.3 passed, Finish button is disabled because Drive, Box and Dropbox accounts have not been linked");
        }
    }
}
