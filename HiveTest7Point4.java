...
int size = driver.findElements(By.xpath("//button[@form='onboardingCardActionsForm']")).size();//ElementNotVisibleException thrown otherwise
        ...
        WebElement illDoThisLaterButton2 = driver.findElement(By.cssSelector(".hv.btn.btn-default.js-complete-step"));

        illDoThisLaterButton2.click();
        ...
        String newPageUrl = driver.getPageSource();

        if(newPageUrl.equals(currentPageUrl))
        {
            System.out.println("Test 7.4 failed, the \"I'll do this later\" button did not route to a new page");
        }
        else
        {
            System.out.println("Test 7.4 passed, the \"I'll do this later button\" routed to a new page");
        }
